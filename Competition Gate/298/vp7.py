...
def simulator(viruses, number_of_day, print_format):
    if print_format == 1:
        for day in range(1, number_of_day + 1):
            ...
            for virus in viruses:
                ...
                if is_updated:
                    print("Nama: {}; Usia: {}; Tingkat Keganasan: {}".format(virus.name, str(virus.age), str(virus.malignancy)))
    else:
        for virus in viruses:
            print("Nama: {}".format(virus.name))
            for day in range(1, number_of_day + 1):
                is_updated = virus.update()

                if is_updated:
                    print("Hari #{}; Usia: {}; Tingkat Keganasan: {}".format(day, str(virus.age), str(virus.malignancy)))
                else:
                    break
...
if __name__ == "__main__":
    ...
    simulator(viruses, number_of_day, print_format)
